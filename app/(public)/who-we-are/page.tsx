...
export default async function WhoWeArePage() {
  ...
  return (
    <>
      ...
      {/* ── Our Christian Foundational Creed ── */}
      <section className="bg-[var(--color-bg)] py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="rounded-3xl border border-[rgb(26_60_52/0.08)] bg-white p-10 shadow-sm">
              <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-[var(--color-primary)]">
                {t("creedHeading")}
              </p>
              <div className="space-y-6 text-[var(--color-muted-fg)] leading-relaxed">
                <p>{t("creedP1")}</p>
                <p>{t("creedP2")}</p>
                <p>{t("creedP3")}</p>
                <p>{t("creedP4")}</p>
      ...
      <section className="bg-[var(--color-bg)] py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { icon: Star, title: t("valueLeadershipTitle"), desc: t("valueLeadershipDesc") },
              { icon: Award, title: t("valueExcellenceTitle"), desc: t("valueExcellenceDesc") },
              { icon: Shield, title: t("valueAccountabilityTitle"), desc: t("valueAccountabilityDesc") },
              { icon: Sparkles, title: t("valueInnovationTitle"), desc: t("valueInnovationDesc") },
              { icon: Heart, title: t("valueTrustTitle"), desc: t("valueTrustDesc") },
              { icon: Users, title: t("valuePeopleCenteredTitle"), desc: t("valuePeopleCenteredDesc") },
            ].map((v, i) => (
