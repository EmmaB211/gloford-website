      ...
      <div className="space-y-6">
        <section className="rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-card)] p-5 space-y-4">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <Field label="Project type" hint="Choose whether this is a current or completed project">
              <select value={status} onChange={(e) => setStatus(e.target.value as ContentStatus)} className={inputCls}>
                <option value="PUBLISHED">Current project</option>
                <option value="ARCHIVED">Completed project</option>
              </select>
            </Field>
          </div>
