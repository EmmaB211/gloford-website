...
describe("sanitizeHtml", () => {
  ...
  it("preserves safe object tags for PDF embeds", () => {
    expect(sanitizeHtml('<object data="/api/media/file/report.pdf" type="application/pdf" width="100%" height="600"></object>')).toBe(
      '<object data="/api/media/file/report.pdf" type="application/pdf" width="100%" height="600"></object>',
    );
  });

  it("strips embed/form/input tags", () => {
