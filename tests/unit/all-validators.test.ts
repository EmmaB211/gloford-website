...
describe("page validators", () => {
  ...
  it("accepts an explicit page status for partner selection", () => {
    expect(pageCreateSchema.safeParse({ slug: "partner-acme", title: "Acme", status: "ARCHIVED" }).success).toBe(true);
  });
